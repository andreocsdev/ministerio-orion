...
export async function PATCH(request: Request) {
  try {
    ...
    const parsed = z
      .object({ read_bible: z.boolean().optional(), read_lesson: z.boolean().optional() })
      .refine((data) => data.read_bible !== undefined || data.read_lesson !== undefined, { message: 'At least one of read_bible or read_lesson must be provided' })
      .safeParse(body);
